...
<body>
		...
		<div class="container">
			<div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center"
				...
				<div class="col-md-10 text-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
					<h1 class="mb-0">Safety Zone Cities</h1>
					<h3 class="subheading mb-4 pb-1">Sutainable cities and communities</h3>
					...
					<body>
						...
						<a href="tel:+66970127542" class="button">
							<button class="button">SOS</button>
						</a>
						<div class="mouse">
	...
	<section class="ftco-intro py-5" style="background-image: url(images/bg_3.jpg);">
		<div class="overlay"></div>
		<div class="container">
			<div class="row d-flex align-items-center">
				<div class="col-md-6 ftco-animate">
					<div class="time">
						...
						<p><a href="#" class="btn btn-primary px-4 py-2">LIST LOCATION</a></p>
					</div>
				</div>
				<div class="col-md-6 pl-md-5 ftco-animate">
					<div style="width: 100%"><iframe width="100%" height="150%" src="https://maps.google.com/maps?width=100%
										&amp;height=600&amp;hl=en&amp;q=King's%20Mongkut%20University%20of%20Technology%20Thonburi%20pracha%20uthit%20road%2C%20bangmot%2C%20
										Thung%20Khru%2C%20bangkok+(My%20Business%20Name)&amp;ie=UTF8&amp;t=&amp;z=16&amp;iwloc=B&amp;output=embed"
		...
		<div class="container">
			<div class="row justify-content-center mb-5 pb-3">
				<div class="col-md-12 text-center heading-section ftco-animate">
					<h2 class="mb-2"><span class="px-4">ABOUT US</span></h2>
					This website created by SIT students at KMUTT during the hackathon event for college studentsto have a better
					security environment so that they would feel confident and worries. "Click once, arrive home"
				</div>
			</div>
			...
			<div class="row d-flex">
				<div class="col-md-6 order-last d-flex flex-column align-items-stretch">
					<div class="img d-flex align-self-stretch align-items-center justify-content-center"
						...
						<div class="desc">
							<!--<h3><a href="#" class="p-2">Poilcy</a></h3>-->
							<p class="mt-4">
								<a href="#" class="btn-custom  p-2 text-center" id="idbox"> Poilcy</a>
							</p>
						</div>
					</div>
					<div class="img d-flex align-self-stretch align-items-center justify-content-center"
						...
						<div class="desc">
							<a href="#" class="btn-custom  p-2 text-center" id="idbox">Find New Friends</a>
						</div>
					</div>
				</div>
				<!-- <div class="cam"> -->
				<div class="col-md-6 px-5 py-5 cam">
					<div class="row justify-content-start pt-3 pb-3">
						<div class="col-md-12 heading-section heading-section-no-line ftco-animate">
							<center>
								<h2 class="mb-4">Campaign<br>
									"Return home safety with friends"
								</h2>
								<p>Just one click save one life</p>
					...
					<div class="col-md-6 justify-content-center counter-wrap ftco-animate">
						<div class="block-18 text-center py-4 bg-light mb-4">
							<div class="text">
								...
								<strong class="number" data-number="15238">0</strong>
								<span>Members</span>
							</div>
						</div>
					</div>
						...
						<div class="text pl-md-5">
							...
							<div class="meta">
								<p>
									...
									<span><i class="icon-location_city mr-2"></i> 203 Fake St. Mountain View, San Francisco, California,
										USA</span>
								</p>
							</div>
					...
					<div class="subsermon p-5">
						...
						<div class="sermon-wrap mb-4 ftco-animate">
							...
							<div class="text">
								...
								<p class="mt-4">
									<a href="https://vimeo.com/45830194" class="btn-custom  p-2 text-center popup-vimeo"><span
											class="icon-play"></span> Watch Sermons</a>
								</p>
								<p class="mt-4">
									<a href="#" class="btn-custom  p-2 text-center"><span class="icon-download"></span> Download
										Sermons</a>
								</p>
							</div>
						</div>
...
</html><?php /**PATH /Users/kritamate/Desktop/hackathon 2/project/resources/views/welcome.blade.php ENDPATH**/ ?>